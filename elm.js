   ...
   board) {
      return function () {
         ...
         var $ = dart.collidedWithBoard ? {ctor: "_Tuple2"
                                          ,_0: board.radius * $Basics.cos(dartAngle)
                                          ,_1: dart.height / 2 + board.y + board.radius * $Basics.sin(dartAngle)} : {ctor: "_Tuple2"
                                                                                                                    ,_0: dart.x
                                                                                                                    ,_1: dart.y},
         x$ = $._0,
         y$ = $._1;
         var vy$ = dart.isFired && $Basics.not(dart.collidedWithBoard) ? 400 : 0;
