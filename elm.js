...
Elm.Aa.make = function (_elm) {
   ...
   angle,
   form) {
      return $Graphics$Collage.rotate(angle)($Graphics$Collage.move({ctor: "_Tuple2"
                                                                    ,_0: x
                                                                    ,_1: y})(form));
   });
   var displayBoard = function (board) {
      ...
      board.x,
      board.y,
      board.angle)($Graphics$Collage.group(_L.fromArray([$Graphics$Collage.filled($Color.black)($Graphics$Collage.circle(board.radius))
         ...
         return function () {
            ...
            {case "_Tuple2":
               return A3($Graphics$Element.container,
                 ...
                 _v0._0,
                 _v0._1)(A2($Basics._op["++"],
                 _L.fromArray([A2(displayBackground,
                              _v0._0,
                              _v0._1)
                              ,displayBoard(_v1.board)]),
                 A2($List.map,
                 displayDart,
                 _v1.player.darts))));}
            _U.badCase($moduleName,
            "between lines 233 and 238");
         }();
      }();
   });
   ...
   _v6) {
      return function () {
         return function () {
            var angle$ = _U.eq(_v6.direction,
            Left) ? _v6.angle + _v6.angularVelocity * delta : _v6.angle - _v6.angularVelocity * delta;
            return _U.replace([["x"
                               ,_v6.x + _v6.vx * delta]
                              ,["y",_v6.y + _v6.vy * delta]
                              ,["angle",angle$]],
            _v6);
         }();
      }();
   ...
   board) {
      return function () {
         return function () {
            ...
            var $ = A2(collidedWithBoard,
            _v8,
            board) ? {ctor: "_Tuple2"
                     ,_0: _v8.y
                     ,_1: board.angle} : {ctor: "_Tuple2"
                                         ,_0: dart$.y
                                         ,_1: dart$.angle},
            y$ = $._0,
            angle$ = $._1;
